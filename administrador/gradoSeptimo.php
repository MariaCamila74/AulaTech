...
<body>
    ...
    <main>
        <div class="septimo1">
            <?php
                $sql = "SELECT * FROM estudiantes WHERE Grado = 701";
                ...
                <?php
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td>" . htmlspecialchars($row['NumeroMatricula']) . "</td>";
        ...
        <table id="datosTabla">
            <h2>7°2</h2>
            <?php
                $consulta2 = "SELECT * FROM estudiantes WHERE Grado = 702";
        ...
        <table id="datosTabla">
            <h2>7°3</h2>
            <?php
                $consulta3 = "SELECT * FROM estudiantes WHERE Grado = 703";
        ...
        <table id="datosTabla">
            <h2>7°4</h2>
            <?php
                $consulta4 = "SELECT * FROM estudiantes WHERE Grado = 704";
        ...
        <table id="datosTabla">
            <h2>7°5</h2>
            <?php
                $consulta5 = "SELECT * FROM estudiantes WHERE Grado = 705";
        ...
        <table id="datosTabla">
            <h2>7°6</h2>
            <?php
                $consulta6 = "SELECT * FROM estudiantes WHERE Grado = 706";
        ...
        <table id="datosTabla">
            <h2>7°7</h2>
            <?php
                $consulta7 = "SELECT * FROM estudiantes WHERE Grado = 707";
