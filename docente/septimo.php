...
<body>
    ...
    <main>
        <div class="septimo1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 701";
        ...
        <table id="datosTabla">
            <h2>7°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 702";
        ...
        <table id="datosTabla">
            <h2>7°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 703";
        ...
        <table id="datosTabla">
            <h2>7°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 704";
        ...
        <table id="datosTabla">
            <h2>7°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 705";
        ...
        <table id="datosTabla">
            <h2>7°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 706";
        ...
        <table id="datosTabla">
            <h2>7°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 707";
