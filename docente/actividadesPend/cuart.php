...
<body>
    ...
    <div class="containerr">
        <div class="cuarto1">
            <h2>4°1</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 401";
        ...
        <div class="cuarto2">
            <h2>4°2</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 402";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="cuarto3">
            <h2>4°3</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 403";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="cuarto4">
            <h2>4°4</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 404";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="cuarto5">
            <h2>4°5</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 405";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="cuarto6">
            <h2>4°6</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 406";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="cuarto7">
            <h2>4°7</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 407";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
