...
<body>
    ...
    <div class="containerr">
        <div class="decimo1">
            <h2>10°1</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1001";
        ...
        <div class="decimo2">
            <h2>10°2</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1002";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="decimo3">
            <h2>10°3</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1003";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="decimo4">
            <h2>10°4</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1004";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="decimo5">
            <h2>10°5</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1005";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="decimo6">
            <h2>10°6</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1006";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="decimo7">
            <h2>10°7</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 1007";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
