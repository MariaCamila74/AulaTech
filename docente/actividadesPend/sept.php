...
<body>
    ...
    <div class="containerr">
        <div class="septimo1">
            <h2>7°1</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 701";
        ...
        <div class="septimo2">
            <h2>7°2</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 702";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="septimo3">
            <h2>7°3</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 703";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="septimo4">
            <h2>7°4</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 704";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="septimo5">
            <h2>7°5</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 705";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="septimo6">
            <h2>7°6</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 706";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="septimo7">
            <h2>7°7</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 707";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
