...
<body>
    ...
    <div class="containerr">
        <div class="sexto1">
            <h2>6°1</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 601";
        ...
        <div class="sexto2">
            <h2>6°2</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 602";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla"">
                <thead>
        ...
        <div class="sexto3">
            <h2>6°3</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 603";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="sexto4">
            <h2>6°4</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 604";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="sexto5">
            <h2>6°5</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 605";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="sexto6">
            <h2>6°6</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 606";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="sexto7">
            <h2>6°7</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 607";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
