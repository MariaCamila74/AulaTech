...
<body>
    ...
    <div class="containerr">
        <div class="noveno1">
            <h2>9°1</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 901";
        ...
        <div class="noveno2">
            <h2>9°2</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 902";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="noveno3">
            <h2>9°3</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 903";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="noveno4">
            <h2>9°4</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 904";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="noveno5">
            <h2>9°5</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 905";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="noveno6">
            <h2>9°6</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 906";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="noveno7">
            <h2>9°7</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 907";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
