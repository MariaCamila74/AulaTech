...
<body>
    ...
    <div class="containerr">
        <div class="quinto1">
            <h2>5°1</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 501";
        ...
        <div class="quinto2">
            <h2>5°2</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 502";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla"">
                <thead>
        ...
        <div class="quinto3">
            <h2>5°3</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 503";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="quinto4">
            <h2>5°4</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 504";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="quinto5">
            <h2>5°5</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 505";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="quinto6">
            <h2>5°6</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 506";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="quinto7">
            <h2>5°7</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 507";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
