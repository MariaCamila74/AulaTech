...
<body>
    ...
    <div class="containerr">
        <div class="undecimo1">
            <h2>11°1</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1101";
        ...
        <div class="undecimo2">
            <h2>11°2</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1102";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="undecimo3">
            <h2>11°3</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1103";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="undecimo4">
            <h2>11°4</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1104";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="undecimo5">
            <h2>11°5</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1105";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="undecimo6">
            <h2>11°6</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1106";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="undecimo7">
            <h2>11°7</h2>
            <?php
                $sql = "SELECT * FROM actividadesrealizadas WHERE Grupo = 1107";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
