...
<body>
    ...
    <div class="containerr">
        <div class="octavo1">
            <h2>8°1</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 801";
        ...
        <div class="octavo2">
            <h2>8°2</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 802";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="octavo3">
            <h2>8°3</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 803";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="octavo4">
            <h2>8°4</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 804";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="octavo5">
            <h2>8°5</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 805";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="octavo6">
            <h2>8°6</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 806";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
        ...
        <div class="octavo7">
            <h2>8°7</h2>
            <?php
                $sql = "SELECT * FROM actividadespendientes WHERE Grupo = 807";
                $result = $conn->query($sql);   
            ?>
            <table id="datosTabla">
                <thead>
