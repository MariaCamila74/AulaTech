...
<body>
    ...
    <main>
        <div class="sexto1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 601";
        ...
        <table id="datosTabla">
            <h2>6°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 602";
        ...
        <table id="datosTabla">
            <h2>6°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 603";
        ...
        <table id="datosTabla">
            <h2>6°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 604";
        ...
        <table id="datosTabla">
            <h2>6°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 605";
        ...
        <table id="datosTabla">
            <h2>6°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 606";
        ...
        <table id="datosTabla">
            <h2>6°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 607";
