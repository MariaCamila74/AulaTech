...
<body>
    ...
    <main>
        <div class="quinto1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 501";
        ...
        <table id="datosTabla">
            <h2>5°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 502";
        ...
        <table id="datosTabla">
            <h2>5°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 503";
        ...
        <table id="datosTabla">
            <h2>5°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 504";
        ...
        <table id="datosTabla">
            <h2>5°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 505";
        ...
        <table id="datosTabla">
            <h2>5°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 506";
        ...
        <table id="datosTabla">
            <h2>5°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 507";
