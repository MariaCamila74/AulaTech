...
<body>
    ...
    <main>
        <div class="octavo1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 801";
        ...
        <table id="datosTabla">
            <h2>8°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 802";
        ...
        <table id="datosTabla">
            <h2>8°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 803";
        ...
        <table id="datosTabla">
            <h2>8°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 804";
        ...
        <table id="datosTabla">
            <h2>8°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 805";
        ...
        <table id="datosTabla">
            <h2>8°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 806";
        ...
        <table id="datosTabla">
            <h2>8°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 807";
