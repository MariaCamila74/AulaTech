...
<body>
    <header>
        ...
        <nav class="navbar hidden" id="navbar">
            <ul class="menu">
                <li><a href="estudiantes-por-equipo.php">Volver</a></li>
                <li>
    ...
    <main>
        <div class="undecimo1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 1101";
        ...
        <table id="datosTabla">
            <h2>11°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 1102";
        ...
        <table id="datosTabla">
            <h2>11°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 1103";
        ...
        <table id="datosTabla">
            <h2>11°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 1104";
        ...
        <table id="datosTabla">
            <h2>11°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 1105";
        ...
        <table id="datosTabla">
            <h2>11°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 1106";
        ...
        <table id="datosTabla">
            <h2>11°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 1107";
