...
<body>
    ...
    <main>
        <div class="decimo1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 1001";
        ...
        <table id="datosTabla">
            <h2>10°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 1002";
        ...
        <table id="datosTabla">
            <h2>10°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 1003";
        ...
        <table id="datosTabla">
            <h2>10°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 1004";
        ...
        <table id="datosTabla">
            <h2>10°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 1005";
        ...
        <table id="datosTabla">
            <h2>10°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 1006";
        ...
        <table id="datosTabla">
            <h2>10°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 1007";
