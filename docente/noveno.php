...
<body>
    ...
    <main>
        <div class="noveno1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 901";
        ...
        <table id="datosTabla">
            <h2>9°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 902";
        ...
        <table id="datosTabla">
            <h2>9°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 903";
        ...
        <table id="datosTabla">
            <h2>9°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 904";
        ...
        <table id="datosTabla">
            <h2>9°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 905";
        ...
        <table id="datosTabla">
            <h2>9°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 906";
        ...
        <table id="datosTabla">
            <h2>9°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 907";
