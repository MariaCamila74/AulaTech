...
<body>
    ...
    <main>
        <div class="cuarto1">
            <?php
                $sql = "SELECT * FROM computadoresusados WHERE Grupo = 401";
        ...
        <table id="datosTabla">
            <h2>4°2</h2>
            <?php
                $consulta2 = "SELECT * FROM computadoresusados WHERE Grupo = 402";
        ...
        <table id="datosTabla">
            <h2>4°3</h2>
            <?php
                $consulta3 = "SELECT * FROM computadoresusados WHERE Grupo = 403";
        ...
        <table id="datosTabla">
            <h2>4°4</h2>
            <?php
                $consulta4 = "SELECT * FROM computadoresusados WHERE Grupo = 404";
        ...
        <table id="datosTabla">
            <h2>4°5</h2>
            <?php
                $consulta5 = "SELECT * FROM computadoresusados WHERE Grupo = 405";
        ...
        <table id="datosTabla">
            <h2>4°6</h2>
            <?php
                $consulta6 = "SELECT * FROM computadoresusados WHERE Grupo = 406";
        ...
        <table id="datosTabla">
            <h2>4°7</h2>
            <?php
                $consulta7 = "SELECT * FROM computadoresusados WHERE Grupo = 407";
